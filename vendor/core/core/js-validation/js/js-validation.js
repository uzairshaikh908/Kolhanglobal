  ...
  e.extend(e.fn, {
          ...
          a.settings.onsubmit &&
            (this.on("click.validate", ":submit", function (t) {
              (a.submitButton = t.target),
                e(this).hasClass("cancel") && (a.cancelSubmit = !0),
              ...
              function n() {
                ...
                return (
                  ...
                  !a.settings.submitHandler ||
                    ((r = a.settings.submitHandler.call(a, a.currentForm, t)),
    ...
    rules: function (t, a) {
        ...
        switch (
          ...
          case "add":
            e.extend(i, e.validator.normalizeRule(a)),
              ...
              (r[u.name] = i),
              a.messages &&
                (n.messages[u.name] = e.extend(n.messages[u.name], a.messages));
            break;
          case "remove":
            return a
              ? ((l = {}),
                e.each(a.split(/\s/), function (t, a) {
                  (l[a] = i[a]),
                    delete i[a],
                    "required" === a && e(u).removeAttr("aria-required");
                }),
                l)
              : (delete r[u.name], i);
        }
      return (
        ...
        s.remote &&
          ((o = s.remote), delete s.remote, (s = e.extend(s, { remote: o }))),
        s
      );
    },
  }),
    ...
    e.extend(e.validator, {
      ...
      prototype: {
        init: function () {
          ...
          e.each(this.settings.groups, function (t, n) {
            ...
            e(this.currentForm)
              .find("[required], [data-rule-required], .required:not(label)")
          ...
          return e(this.currentForm)
            ...
            .filter(function () {
              return (
                ...
                !(this.name in a || !t.objectLength(e(this).rules())) &&
                  ((a[this.name] = !0), !0)
              );
            });
        },
        ...
        check: function (t) {
          ...
          for (n in i) {
            ...
            try {
              if (
                "dependency-mismatch" ===
                  (a = e.validator.methods[n].call(this, l, t, r.parameters)) &&
                1 === s
              ) {
                o = !0;
                continue;
        ...
        customDataMessage: function (t, a) {
          return (
            e(t).data(
              "msg" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase()
            ) || e(t).data("msg")
          );
        },
        ...
        formatAndAdd: function (t, a) {
          ...
          "function" == typeof n
            ...
            : r.test(n) &&
              (n = e.validator.format(n.replace(r, "{$1}"), a.parameters)),
            this.errorList.push({ message: n, element: t, method: a.method }),
            ...
            : ((n = s =
              ...
              s.is("label")
                ...
                : 0 === s.parents("label[for='" + o + "']").length &&
                  ((i = s.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1")),
                  l
                    ? l.match(new RegExp("\\b" + i + "\\b")) || (l += " " + i)
                    : (l = i),
                  e(t).attr("aria-describedby", l),
                  (r = this.groups[t.name]) &&
                    e.each(this.groups, function (t, a) {
                      a === r &&
                        e("[name='" + t + "']", this.currentForm).attr(
                          "aria-describedby",
                          s.attr("id")
                        );
                    }))),
        ...
        destroy: function () {
          this.resetForm(),
            e(this.currentForm).off(".validate").removeData("validator");
        },
      },
      classRuleSettings: {
        required: { required: !0 },
          ...
          n &&
            e.each(n.split(" "), function () {
              this in e.validator.classRuleSettings &&
                e.extend(a, e.validator.classRuleSettings[this]);
            }),
          a
        );
      },
      ...
      dataRules: function (t) {
        ...
        for (a in e.validator.methods)
          (n = i.data(
            "rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase()
          )),
            this.normalizeAttributeRule(r, s, a, n);
        return r;
      },
      staticRules: function (t) {
        ...
        return (
          n.settings.rules &&
            (a = e.validator.normalizeRule(n.settings.rules[t.name]) || {}),
          a
        );
      },
          ...
          e.each(t, function (n, r) {
            if (!1 !== r) {
              if (r.param || r.depends) {
                ...
                i ? (t[n] = void 0 === r.param || r.param) : delete t[n];
              }
            } else delete t[n];
          }),
          e.each(t, function (n, r) {
        ...
        remote: function (t, a, n) {
          ...
          return (
            this.settings.messages[a.name] ||
              (this.settings.messages[a.name] = {}),
            (s.originalMessage = this.settings.messages[a.name].remote),
                    ...
                    !0,
                    {
                      ...
                      success: function (n) {
                        var i,
                          ...
                          l,
                          u = !0 === n || "true" === n;
                        (r.settings.messages[a.name].remote =
                          s.originalMessage),
                          u
                            ? ((l = r.formSubmitted),
                              r.prepareElement(a),
                              ...
                              delete r.invalid[a.name],
                              r.showErrors())
                            : ((i = {}),
                              (o = n || r.defaultMessage(a, "remote")),
                              (i[a.name] = s.message =
                                e.isFunction(o) ? o(t) : o),
                              (r.invalid[a.name] = !0),
                              r.showErrors(i)),
                          (s.valid = u),
                          r.stopRequest(a, u);
  ...
  e.ajaxPrefilter
    ...
    : ((t = e.ajax),
      (e.ajax = function (n) {
        ...
        return "abort" === r
          ? (a[i] && a[i].abort(), (a[i] = t.apply(this, arguments)), a[i])
    ...
    return (
      ...
      ((e = function (e) {
        ...
        parseDate: function (e, a) {
          ...
          if ("U" === a) return (i = parseInt(e)) ? new Date(1e3 * i) : e;
          switch (typeof e) {
            case "number":
              return new Date(e);
            case "string":
          ...
          for (i = n.length - 1; i >= 0; i--) "S" === n[i] && n.splice(i, 1);
          for (
            ...
            switch (((s = r[i]), (o = parseInt(s)), n[i])) {
              ...
              case "Y":
                if (!o) return null;
                (h = s.length),
                  (v.year = 2 === h ? parseInt((o < 70 ? "20" : "19") + s) : o),
                  (f = !0);
                break;
              case "m":
              case "n":
        ...
        guessDate: function (e, t) {
          ...
          for (r = 0; r < l.length; r++) {
            if (((h = 2), (s = l[r]), (o = parseInt(s.substr(0, 2))), isNaN(o)))
              return null;
            switch (r) {
              case 0:
                "m" === u[0] || "n" === u[0] ? d.setMonth(o - 1) : d.setDate(o);
                break;
              case 1:
                "m" === u[0] || "n" === u[0] ? d.setDate(o) : d.setMonth(o - 1);
                break;
              case 2:
                if (
                  ((n = d.getFullYear()),
                  (h = (a = s.length) < 4 ? a : 4),
                  !(n = parseInt(
                    a < 4 ? n.toString().substr(0, 4 - a) + s : s.substr(0, 4)
                  )))
                )
                  return null;
                d.setFullYear(n);
      ...
      -1 === e.name.indexOf("[") ||
        ...
        $.each(a.settings.rules, function (a, r) {
          if (a in n[e.name]) $.extend(t, n[e.name][a]);
            ...
            n[e.name][a] = {};
            const i = laravelValidation.helpers.regexFromWildcard(a);
            if (e.name.match(i)) {
  ...
  setupValidations: function () {
    $.validator.addMethod(
      ...
      function (e, t, a) {
        ...
        return (
          $.each(a, function (e, t) {
            t[3] || -1 !== laravelValidation.implicitRules.indexOf(t[0])
              ? s.unshift(t)
              : s.push(t);
          }),
          $.each(s, function (a, s) {
            const o =
                s[3] || -1 !== laravelValidation.implicitRules.indexOf(s[0]),
              l = s[0],
              u = s[2];
                  ...
                  laravelValidation.methods[l].call(
                    ...
                    function (a) {
                      if (
                        ...
                        const a = {};
                        (a[t.name] = i.message = $.isFunction(u) ? u(e) : u),
                          (n.invalid[t.name] = !0),
                          n.showErrors(a);
                      }
                      n.showErrors(n.errorMap), (i.valid = a);
                    }
                  )),
                !0 !== r
                  ? (n.settings.messages[t.name] ||
                      (n.settings.messages[t.name] = {}),
                    (n.settings.messages[t.name].laravelValidation = u),
                    !1)
                  : void 0);
          }),
          r
      ...
      $.validator.addMethod(
        ...
        function (e, t, a) {
          ...
          n.settings.messages[t.name] || (n.settings.messages[t.name] = {}),
            (r.originalMessage =
              n.settings.messages[t.name].laravelValidationRemote),
            (n.settings.messages[t.name].laravelValidationRemote = r.message);
          var h = ("string" == typeof h && { url: h }) || h;
          if (laravelValidation.helpers.arrayEquals(r.old, e) || r.old === e)
            return r.valid;
          (r.old = e),
            (i = $(n.currentForm).serializeArray()),
            i.push({ name: "_js_validation", value: l }),
            i.push({ name: "_js_validation_validate_all", value: d });
          ...
          return (
            ...
            $.ajax(
              $.extend(
                !0,
                {
                  ...
                  beforeSend: function (e) {
                    if (
                      "get" !== $(n.currentForm).attr("method").toLowerCase() &&
                      u
                    )
                      return e.setRequestHeader("X-XSRF-TOKEN", u);
                  },
                  complete: function () {
                    $(n.currentForm)
              ...
              let s, o, l, u;
              if ("error" === i)
                (u = !1), (a = laravelValidation.helpers.parseErrorResponse(a));
              else {
                if ("success" !== i) return;
                u = !0 === a || "true" === a;
              }
              (n.settings.messages[t.name].laravelValidationRemote =
                ...
                u
                  ...
                  : ((s = {}),
                    ...
                    (s[t.name] = r.message = $.isFunction(o) ? o(e) : o[0]),
                    (n.invalid[t.name] = !0),
                    n.showErrors(s)),
  ...
  $.extend(!0, laravelValidation, {
    helpers: {
      ...
      selector: function (e) {
        var t = [];
        $.isArray(e) || (e = [e]);
        for (var a = 0; a < e.length; a++) t.push("[name='" + e[a] + "']");
        return t.join();
      },
      ...
      hasRules: function (e, t) {
        ...
        return (
          ...
          e.name in n.settings.rules && r.push(n.settings.rules[e.name]),
          $.each(r, function (e, n) {
            if ("laravelValidation" in n)
              for (var r = n.laravelValidation, i = 0; i < r.length; i++)
                if (-1 !== $.inArray(r[i][0], t)) return (a = !0), !1;
          }),
          a
        );
      },
      ...
      parseTime: function (e, t) {
        ...
        return (
          null == t
            ? (a = this.strtotime(e))
            : (a = n.parseDate(e, t)) && (a = Math.round(a.getTime() / 1e3)),
          a
        );
      },
      guessDate: function (e, t) {
  ...
  $.extend(!0, laravelValidation, {
    methods: {
      ...
      RequiredWith: function (e, t, a) {
        ...
        return (
          $.each(a, function (e, a) {
            var s = laravelValidation.helpers.dependentElement(i, t, a);
            r =
              r ||
              (void 0 !== s &&
                $.validator.methods.required.call(n, i.elementValue(s), s, !0));
          }),
      ...
      RequiredIf: function (e, t, a) {
        var n = laravelValidation.helpers.dependentElement(this, t, a[0]);
        if (void 0 !== n) {
      ...
      Same: function (e, t, a) {
        var n = laravelValidation.helpers.dependentElement(this, t, a[0]);
        return void 0 !== n && String(e) === String(this.elementValue(n));
      },
      InArray: function (e, t, a) {
        ...
        for (
          ...
          var o = n[s].name;
          if (o.match(i)) {
            var l = laravelValidation.methods.Same.call(this, e, t, [o]);
            r = r || l;
          }
        }
        return r;
      ...
      Array: function (e, t) {
        return (
          (-1 !== t.name.indexOf("[") && -1 !== t.name.indexOf("]")) ||
          $.isArray(e)
        );
      },
      Boolean: function (e) {
      ...
      Size: function (e, t, a) {
        return (
          laravelValidation.helpers.getSize(this, t, e) === parseFloat(a[0])
        );
      },
      Between: function (e, t, a) {
        return (
          laravelValidation.helpers.getSize(this, t, e) >= parseFloat(a[0]) &&
          laravelValidation.helpers.getSize(this, t, e) <= parseFloat(a[1])
        );
      },
      Min: function (e, t, a) {
        return (
      ...
      Alpha: function (e) {
        return (
          "string" == typeof e && new RegExp("^(?:^[a-zà-ü]+$)$", "i").test(e)
        );
      },
      AlphaNum: function (e) {
        return (
      ...
      Before: function (e, t, a) {
        var n = parseFloat(a);
        if (isNaN(n)) {
          var r = laravelValidation.helpers.dependentElement(this, t, a);
          if (void 0 === r) return !1;
          n = laravelValidation.helpers.parseTime(this.elementValue(r), r);
        }
